...
<form action="cb_search.php" method="post" id="mySearch">
  <label for="name">Search Name</label>
  <input type="text" id="sname" name="sname">
  <input type="submit" value="Search" class="homebutton" id="myBtn" name="myBtn"/>
</form>
...
/*$sql = "SELECT clientscb.Name, clientscb_date.client_date, clientscb.Phone, clientscb_date.date_keyed
FROM clientscb
INNER JOIN clientscb_date ON clientscb.Name=clientscb_date.client_id
ORDER BY clientscb.Name, clientscb_date.client_date";
...
$sql1 = "SELECT Name, Phone FROM clientscb ORDER BY Name";
...
// output data of each row
  while($row1 = $result1->fetch_assoc()) {
    ...
    $name = $row1["Name"];
    $sql2 = "SELECT client_date, date_keyed FROM clientscb_date WHERE client_id = '$name'";
